...
function main(args)
  ...
  command_common_args = [
                         "metadata", Dict(:help => "image metadata file", :required => true),
                         "input", Dict(:help => "input image directory", :required => true),
                         "output", Dict(:help => "output image directory", :required => true)
                        ]
