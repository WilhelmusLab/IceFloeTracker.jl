...
function segmentation_F(
    ...
    leads_segmented_broken = IceFloeTracker.hbreak(leads_segmented) .* .!watershed_intersect
    ...
    return ice_mask_watershed_applied,
    ice_mask_watershed_opened,
    not_ice_dilated,
    reconstructed_leads,
    leads_segmented,
