...
function normalize_image(
    ...
    image_sharpened = IceFloeTracker.add_padding(
        image_sharpened, Pad(:replicate, (radius, radius))
    )
    image_dilated = Images.dilate(image_sharpened, struct_elem)
    image_dilated = IceFloeTracker.remove_padding(
        image_dilated, Pad((radius, radius), (radius, radius))
    )
