@testset "Normalize Image" begin
    ...
    struct_elem2 = IceFloeTracker.make_landmask_se()# readdlm(strel_file_2, ',', Bool) # read in original matlab structuring element -  a disk-shaped kernel with radius of 2 px
