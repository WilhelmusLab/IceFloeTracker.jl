...
@testset "Segmentation-A" begin
    ...
    matlab_segmented_ice = convert(BitMatrix, float64.(load("$(test_data_dir)/matlab_segmented_ice.png")))
    ...
    @time segmented_ice = IceFloeTracker.kmeans_segmentation(ice_water_discriminated_image, ice_labels)
    ...
    @test test_similarity(matlab_segmented_A_bitmatrix, segmented_A, 0.085)
