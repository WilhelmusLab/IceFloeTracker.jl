@testset "Segmentation-F" begin
    ...
    ice_labels =
        Int64.(vec(DelimitedFiles.readdlm("$(test_data_dir)/ice_labels_floe_region.csv", ',')))
    ...
    @test test_similarity(isolated_floes, matlab_isolated_floes[ice_floe_test_region...], 0.07)
end
