@testitem "Segmentation-F" begin
    ...
    segF_binarized = kmeans_binarization(
        morphed_grayscale, 
        apply_cloudmask(fc_image[ice_floe_test_region...], cloudmask[ice_floe_test_region...]);
        k=3,
        cluster_selection_algorithm=LopezAcosta2019.IceDetectionLopezAcosta2019(),
        ) .* .! watershed_intersect[ice_floe_test_region...]
    
    @info "Splitting floes"
    isolated_floes = LopezAcosta2019.morph_split_floes(segF_binarized, cloudmask[ice_floe_test_region...])
