...
@testset "Gradient Functions Tests" begin
    ...
    @testset "inverse_quadratic function" begin
        # Test basic functionality
    ...
    @testset "Gradient function properties" begin
    ...
    @testset "SupportedFunctions construction" begin
    ...
    @testset "SupportedFunctions Base method overloads" begin
        sf = SupportedFunctions()
    ...
    @testset "SupportedFunctions function retrieval and execution" begin
        sf = SupportedFunctions()
    ...
    @testset "SupportedFunctions string representation" begin
        sf = SupportedFunctions()
        str_repr = string(sf)
    ...
    @testset "is_supported helper function" begin
        sf = SupportedFunctions()
    ...
    @testset "SUPPORTED_GRADIENT_FUNCTIONS constant" begin
    ...
    @testset "Integration with nonlinear diffusion" begin
