...
2. After pushing the changes and starting a new PR, add `@JuliaRegistrator register` in a comment in the commit you wish to use for the release (not a comment on the PR, but the actual commit)
